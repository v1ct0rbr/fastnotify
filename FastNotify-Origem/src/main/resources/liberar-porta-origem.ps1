...
<#
  FastNotify Origem - libera/remove a regra de ENTRADA da porta de cadastro.
  A porta e lida apenas de config\origem.properties (chave registerPort).

  Uso (admin):
    .\liberar-porta-origem.ps1
    .\liberar-porta-origem.ps1 -Acao Remove
    .\liberar-porta-origem.ps1 -Acao Status

  Regra: FastNotify-Origem-Cadastro (TCP inbound)
#>
[CmdletBinding()]
param(
...
$RuleName = 'FastNotify-Origem-Cadastro'
$RuleLabel = 'FastNotify - firewall porta cadastro Origem'
$ConfigFile = 'origem.properties'
$ConfigKey = 'registerPort'
...
Write-Host 'FastNotify Origem - firewall (porta de cadastro)'
